						...
						<form action='seasonRegister' method='post'>
							...
							<div class="form-group">
								...
								<label>제목</label> <input type="text" class="form-control"
									name="seasonTitle" placeholder="제목을 입력하세요" required="required"
									mexlength="50" />
							</div>
							...
							<div class="form-group">
								<label>메인 여부&nbsp;</label> <input type="radio" name="seasonPick"
									value="1">등록&nbsp; <input type="radio"
									name="seasonPick" value="0" checked>미등록
							</div>
