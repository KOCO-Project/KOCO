	...
	<div class="row" style="height: 100%;">
		<div class="col-md-6" style="background-color: #fff;padding: 5rem 5rem 5rem 10rem;">
				...
				<div class="form-group">
					...
					<input type="text" name="userId" placeholder="ID" required="required" class="form-control">
				</div>
				<div class="form-group">
					<label for="userPw"style="display: none;">Password</label>
					<input type="password" name="userPw" placeholder="Password"	required="required" class="form-control">
				</div><br><br>
					<p class="help-block">
						<a href="findUserInfo" class="user">ID 혹은 Password가 기억이 안나십니까?</a><br>
						<a href="registerView" class="user">아직 KOCO회원이 아니십니까?</a>
					</p><br><br>
					<input type="submit" value="Sign In" class="btn btn-success" style="width: 100%;">
			</form>
		</div>
		</div>
		</div>
