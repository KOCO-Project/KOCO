			...
			<form role="form" action="/KOCO/postEventUpdate" method="post" modelAttribute="event" enctype="multipart/form-data">
				...
				<input type='hidden' name='keyword' value='<c:out value="${cri.keyword }"/>'>
					<div class="form-inline form-group">
						...
						<div class="col-sm-10">
						<input type="text" name="boardTitle" class="form-control" size="100" value='<c:out value="${event.boardTitle }"/>'> 
						</div>
					</div>
					<div class="form-inline form-group">
					...
					<button type="submit" data-oper='update' class="btn btn-success">수정완료</button>
